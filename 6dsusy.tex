...
I^{(2)} (Q_1 , Q_2) & =  \int \frac{1}{4}(\Gamma(Q_1, Q_2)_{W_+} , \Gamma(\psi^*, \psi^*)_{U}) - \frac{1}{2} (Q_1, \psi^*)_U(Q_2, \psi^*)_U  .
\end{align*}
where $Q, Q_1,Q_2 \in \Sigma = S_+ \otimes W_+$. 
We point out some conventions in the definition of $I^{(2)}$. 
First, we define $\Gamma (Q_1,Q_2)_{W_+} \in V$ as the image of $Q_1 \otimes Q_2$ under the composition
\[
...
and
\begin{align*}
\{S, I^{(2)}(Q_1,Q_2)\} = & \frac{1}{2} \Gamma(Q_1,Q_2) \Gamma(\psi^*, \sd \dd \psi) - \frac{1}{2} (Q_1, \psi^*) (Q_2, \sd \dd \psi) - \frac{1}{2} (Q_1, \sd \dd \psi) (Q_2, \psi^*) .
\end{align*}
...
\\ 
& + \frac{1}{2} \rho(\Gamma(Q_1,Q_2)) \sd \dd \psi - \frac{1}{2} (Q_2, \sd \dd \psi)Q_1 - \frac{1}{2} (Q_1, \sd \dd \psi)Q_2
\end{align*}
By \label{prop:cliffordactionproperties} item (2), the first, second, fifth, and sixth terms combine to give
\[
- \frac{1}{2} \left( \sd \dd \rho(\Gamma(Q_1,\psi)) Q_2 + \sd \dd \rho(\Gamma(Q_2, \psi))Q_1 \right)  .
\]
