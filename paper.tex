...
&= -\d^{\mr{rot}}_{\mr{CE}} I^{(2)}.
\end{align*}
\chris{I should take care that the signs I introduce when I move $X$ around are all correct here, and probably include more explanation.}
\end{proof}
