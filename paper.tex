...
\d \colon \cE \to \cE [1] 
\]
such that $(1)$: $\d^2 = 0$ and $(2)$: the pair $(\cE , \d)$ is an elliptic complex;
...
\item[$(3)$] satisfies $\int_M \omega\<e_0, \d e_1\> = (-1)^{|e_0|} \int_M \omega(\d e_0, e_1)$ where $e_i$ are compactly supported sections of $E$ .
\end{enumerate}
\end{itemize}
\end{dfn}
