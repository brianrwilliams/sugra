...
\subsubsection{Rank $(2,0)$ topological twist}
...
Fix a K\"ahler structure on $\RR^4$ and denote by $L\subset V$ the $i$-eigenspace of the complex structure. %Moreover, fix a complex volume form on $L$. 
...
\begin{itemize}
 ...
 \item $\gg$-valued fermions: a $W$-valued Dirac spinor $\lambda = (\lambda_+ \otimes \alpha_+, \lambda_-\otimes \alpha_-) \in \Omega^0(\RR^4; (S_+ \otimes W \oplus S_- \otimes W^*) \otimes \gg)$.
