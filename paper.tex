...
\begin{align*}
 S_{\mr{BV}} &= \int \dvol \bigg( \Omega(\lambda_0 \ol \dd_{A_{0,1}} \lambda_{0,2})  + \Omega(\psi_{0,1} \wedge \ol \dd_{A_{0,1}} \psi_{0,1}) + \frac 12 (F_{0,2},\lambda_{0,2}^*) + \frac 12( \ol \dd_{A_{0,1}} \psi_0, \psi_{0,1}^*) +  \ol\dd_{A_{0, 1}} A_0\wedge A_{0, 1}^* \\ 
