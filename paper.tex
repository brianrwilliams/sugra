...
\]
We have written down the full BV action for supersymmetric pure Yang-Mills theory numerous times, which we call $S_{\rm BV, gauge}$. 
...
& \pm g^2 \int (\phi \Bar{\phi}) * (\phi \Bar{\phi}) 
\end{align*}
