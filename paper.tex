...
\textbf{Dimension 8}
\begin{itemize}
 \item \emph{$\mc N=1$ holomorphic twist.} 
 \item \emph{$\mc N=1$ intermediate twist.}
 \item \emph{$\mc N=1$ topological twist.} \cite{AcharyaOLoughlinSpence,BaulieuKannoSinger}
\end{itemize}

\textbf{Dimension 7}
\begin{itemize}
 \item \emph{$\mc N=1$ minimal twist.} 
 \item \emph{$\mc N=1$ intermediate twist.}
 \item \emph{$\mc N=1$ topological twist.} 
\end{itemize}

\textbf{Dimension 6}
\begin{itemize}
 \item \emph{$\mc N=(1,0)$ and $\mc N=(1,1)$ holomorphic twist.} 
