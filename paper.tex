...
&\qquad  + \frac 12 ((\rho(F_A)Q, \lambda_+^*)(u_+^*,  w_+) + \rho(\d_A \phi_2(w_+ \wedge u_-^*))Q, \lambda_-^*) \bigg)\\
I^{(1)}_{\mr{matter}}(Q) &= \\
I^{(2)}_{\mr{gauge}}(Q,Q) &= \\
I^{(2)}_{\mr{matter}}(Q,Q) &= 
\end{align*}
if $Q=Q^+ \otimes w^+$ is an element of $S_+ \otimes W$, and
\begin{align*}
I^{(1)}_{\mr{gauge}}(Q) &= \\
I^{(1)}_{\mr{matter}}(Q) &= \\
I^{(2)}_{\mr{gauge}}(Q,Q) &= \\
I^{(2)}_{\mr{matter}}(Q,Q) &= 
\end{align*}
if $Q=Q^- \otimes W_-$ is an element of $S_- \otimes W^*$.
\end{prop}
...
We now address the rank $(1,1)$ twist.
