...
\subsubsection{$\mc N = (1,0)$ with hypermultiplet matter}
...
\begin{enumerate}
 \item Rank $(1,0)$ spinors, $Q^+ \otimes w^+$.  These automatically square to zero, and are holomorphic, like in the $\mc N=(1,0)$ supersymmetry algebra.
 \item Rank $(1,1)$ spinors, $Q = Q^+ \otimes w^+ + Q^- \otimes w^-$.  These automatically square to zero, and split into two inequivalent classes:
 \begin{enumerate}
 \item \chris{4 invariant directions}
 \item \chris{topological (this twist is a degeneration of the previous type)}
 \end{enumerate}
...
\chris{types 2a and 2b fit into a family of the form $\mr{Map}(S_2 \times \Sigma_{\mr{dR}}, BG)_{\mr{Hod}}$.  Type 3 gives $\mr{Map}(\Sigma \times (M_4)_{\mr{dR}}, BG)$.}

\subsection{Dimension 5}

\subsubsection{$\mc N = 1$ Super Yang-Mills with a Hypermultiplet}

\subsubsection{$\mc N = 2$ Super Yang-Mills Theory}

Exactly as in the case of 6d $\mc N=(1,1)$ supersymmetry algebra, there are 4 inequivalent classes of twists.
\begin{enumerate}
...
\chris{types 2a and 2b fit into a family of the form $\mr{Map}(\Sigma \times (M_3)_{\mr{dR}}, BG)_{\mr{Hod}}$.  Type 3 gives $\mr{Map}((M_5)_{\mr{dR}}, BG)$.}
