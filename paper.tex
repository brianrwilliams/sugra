...
Let $(E, Q_{BV},\omega, I)$ be a classical field theory. 
\begin{itemize}
\item[(1)]
An \defterm{action} of a super Lie algebra $\fg$ on $(E, Q_{BV}, \omega, I)$ is an element of cohomological degree zero 
...
Let $(E, Q_{BV}, \omega, I)$ be a classical field theory and $G$ is a supergroup acting on spacetime $M$. An \defterm{action} of $G$ on $(E, Q_{BV}, \omega, I)$ is given by the following data:
\begin{itemize}
...
Suppose $(E, Q_{BV}, \omega, I)$ is a supersymmetric classical field theory and $(Q, \alpha)$ is a twisting datum. The \defterm{$Q$-twisted classical field theory} is the classical field theory $(E^Q, Q_{BV} + \{\rho_2(Q), -\}, \omega, I + \rho_3(Q) + \dots)$, where
