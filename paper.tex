...
\[
I_{F} (e) = \sum_{k \geq 2} \int_M \frac{1}{(k+1)!} \omega(e, (p^*\ell_k) (e, \ldots, e)) . 
\] 
...
\begin{lemma}
Given a classical BRST theory $(F, Q_{BRST}, I_{BRST})$, the data $(E, Q, \omega, I) = (F \oplus F^![-1] , \ell_1 + Q_{BRST} , I_{BV})$ defines a classical BV theory.
...
\subsubsection{Partially Holomorphic Examples}
...
\brian{check this} In fact, in this example, there is a natural lift to a $\ZZ$-graded theory whereby the coordinates $\epsilon_i$ are given cohomological degree $-1$. 
...
\brian{can't do cokernels in CVS, blah blah}
