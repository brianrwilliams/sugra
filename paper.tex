...
\begin{align*}
\{I^{(1)},I^{(1)}\} &= \{\<A^* , \delta_Q A\> + \<\lambda^*, \delta_Q \lambda\>, \<A^* , \delta_Q A\> + \<\lambda^*, \delta_Q \lambda\> \} \\
&= 2(\langle A^*, [\delta_{Q}, \delta_{Q}] A \rangle + \langle \lambda^*, [\delta_{Q}, \delta_{Q}] \lambda \rangle) \\
 &= 2(\langle A^*, \delta_{[Q,Q]} A \rangle + \langle \lambda^*, \delta_{[Q,Q]} \lambda \rangle  - \rho(\Gamma(Q,Q)) \sd \dd \lambda - \frac 12(Q, \sd \dd \lambda)Q - \frac 12(Q, \sd \dd \lambda)Q) \\
 &= 2\langle A^*, \delta_{[Q,Q]} A \rangle + 2\langle \lambda^*, \delta_{[Q,Q]} \lambda \rangle - 2\{S_{\mr{BV}} , I^{(2)}\} \\
 &=
\end{align*}
Here we applied Lemma \ref{onshell_action_lemma} on the third line, and on the last line we used the 
\chris{What about that $[Q,Q]$ term?  It looks like the interaction $I_{\mr{trans}}$ associated to the translation $[Q,Q]$.}
\end{proof}
