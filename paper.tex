...
I don't see that here -- is that true?  Maybe I'm missing a simplification?  If anything I'm seeing only the second term (which the 3-$\psi$ rule doesn't apply to).  Maybe it's the difference of two expressions to which the rule does apply?}.
