...
\begin{table}[!h]
 ...
 &&& $T^*_{\mr{odd}}\bun_G(\CC^4, BG)$ & \\ \cline{3-5}
 ...
 \multirow{10}*{4} & \multirow{10}*{$4$} & \multirow{2}*{Rank $(1,0)$} & {Holomorphic BF Theory} & \multirow{2}*{2 (holomorphic)} \\
 ...
 &&& $\higgs_G(\CC^2)_{\mr{dR}}$ & \\ \hline
  \multirow{6}*{3} & \multirow{6}*{$8$} & \multirow{2}*{Rank $1$} & {Mixed BF Theory} & \multirow{2}*{2 (minimal)} \\
...
\begin{table}[!h]
 ...
 && \multirow{2}*{Rank $(1,1)$} & {Mixed BF Theory coupled to a mixed symplectic boson} & \multirow{2}*{2 (holomorphic)} \\
 &&& $\mr{Map}(\CC \times \RR^2_{\mr{dR}}, U /\!/G)$ & \\ \cline{3-5}
 && \multirow{2}*{Rank $(2,0)$} & {Perturbatively trivial (Donaldson theory)} & \multirow{2}*{2 (holomorphic)} \\
