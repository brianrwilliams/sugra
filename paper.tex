...
The twist by a rank 2 supercharge of 7d $\mc N=1$ super Yang-Mills theory on the product of a Calabi-Yau 3-fold $X_3$ with an oriented 1-manifold $L$ is equivalent to mixed Chern-Simons theory on $X_3 \times (L)_{\mr{dR}}$.
\end{theorem}
