...
The twist by a rank $4$ supercharge of 5d $\mc N=2$ super Yang-Mills theory on an oriented 5-manifold $M_5$ is equivalent to 5d Chern-Simons theory on $M_5$: the $\ZZ/2\ZZ$-graded theory with space of fields $\mr{Map}(M_5, B\gg)$.
\end{theorem}
