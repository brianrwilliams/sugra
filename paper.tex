...
\brian{Should we say something about coupling here?}
...
The $6$-dimensional $\mc N = (1,0)$ super Yang-Mills theory has BRST fields given by a ghost $c$, a $6$-dimensional gauge field $A$, and a Lie algebra valued spinor
\[
