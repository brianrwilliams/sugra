...
\begin{proof}
This is really just an alternative way of writing the statement of Lemma \ref{onshell_action_lemma}.  Indeed \chris{...}
\end{proof}
...
\begin{proof}
First, note that only the action of $\so(n)$ contributes to the two terms in the expression \ref{rot_invariance_eqn}, since 
\chris{...}
\end{proof}
...
First, the term \ref{MC_1} vanishes by \cite[Proposition 14]{BaezHuerta}.  Baez and Huerta prove that in our four critical dimensions \chris{argue why this is the same}.
...
\chris{Discuss dimensional reduction, and then the inclusion of the action of R-symmetries.}
