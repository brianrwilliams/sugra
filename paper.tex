...
\begin{align*}
I^{(1)}_t &= \int \langle A_{1,0}^\vee, \psi_{1,0}^- + t\psi_{1,0}^+\rangle + \langle \phi_1, \chi_1^+ + t\chi_1^- \rangle + \langle \phi_2, \chi_2^- + t\chi_2^+ \rangle + \langle (\chi_1^-)\vee + t(\chi_1^+)^\vee, \Lambda F_{1,1} \rangle + \\
...
I^{(2)}_t &= \int \langle (\chi_1^+)^\vee + (\chi_1^-)^\vee, (\chi_1^+)^\vee \rangle.
\end{align*}
