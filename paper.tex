...
%\vspace{-10pt}
%\paragraph{Fields:} The BRST fields are given by:
%>>>>>>> 016a15254e190191104552713b6e9bc2dba88afb
%\begin{itemize}
...
\item Matter bosons $\nu\in\Omega^{3,0}(M; U)$, $\phi\in\Omega^0(M; U)$.
\item Matter fermions $\psi\in \Omega^{1, 0}(M; \Pi U\otimes K^{1/2})$, $\wt\nu\in\Omega^0(M; \Pi U\otimes K^{-1/2})$\brian{Should this be $\psi \in \Omega^{0,1}(M; \Pi U\otimes K^{1/2})$?}.
\item A ghost field $c\in \Omega^0(M; \gg)[1]$.
\end{itemize}
...
\end{thm}
\brian{What's our convention for ``twisted maps?}
...
The identity homomorphism $\alpha = {\rm id} \colon \U(1)\rightarrow \U(1)$ given by the identity, makes $Q$ weight $+1$, so in this case we get a $\ZZ$-grading. 
Such a supercharge is stabilized by $G=\SU(2)$. 
...
\]
Moreover, under the twisting homomorphism
\[
\phi = \det \, ^{1/2} : \MU(2) \to \U(1)
\]
we have an identification $W = \det(L)^{1/2}$. 
...
\item Gauge fermions $\chi \in \Omega^0(M ; \Pi \gg)$, $\xi \in \Omega^{2,0}(M ; \Pi \gg)$, $B \in \Omega^{0,2}(M ; \gg)$, $b \in \Omega^{0,1}(M ; \gg)$, $\Tilde{\chi} \in \Omega^0(M ; \gg)$.
%\item Matter bosons $\nu \in \Omega^0(M ; U \otimes K^{-1/2})$, $\phi \in \Omega^0(M ; U \otimes K^{1/2})$.
\item Matter bosons $\nu\in\Omega^{2,0}(M; U)$, $\phi\in\Omega^0(M; U)$.
...
We are left to check that the equivalence respects  the gradings and the $\MU(2)$-action. Indeed, the equivalence given by Theorem \ref{thm:5dminimaltwist} eliminates fields $A_{1, 0}, \Tilde{a}, \rho, \chi, \Tilde{\chi}$ and hence the underlying local $L_\infty$ algebra after the twist becomes
\[
\xymatrix@R=0.5cm@C=0.5cm{
\ul{0} & \ul{1} & \ul{2} & \ul{3} & \\ 
...
\brian{I've copied over Chris' work to another file and am working on it there.}
