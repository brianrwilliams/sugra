...
\item Fermions $\psi\in\Omega^{1, 0}(M; \Pi\gg)$, $B\in\Omega^{0, 2}(M; \Pi\gg)$, $\chi\in\Omega^0(M; \Pi\gg)$.
\item A ghost field $c\in\Omega^0(M; \Pi\gg)$.
\end{itemize}
...
Let $\fg$ be a complex Lie algebra equipped with a symmetric bilinear invariant nondegenerate pairing. We consider $\cN=1$ super Yang--Mills theory on $M=\RR^9$ equipped with the Euclidean metric, where $\fg$ is the complexified Lie algebra of the gauge group.
...
\end{thm}
\begin{proof}
The claim follows from Theorem \ref{thm:10dCSreduction} applied to $L=\CC^4$.
\end{proof}
...
Let $\fg$ be a complex Lie algebra equipped with a symmetric bilinear invariant nondegenerate pairing. We consider $\cN=1$ super Yang--Mills theory on $M=\RR^8$ with the Euclidean metric, where $\fg$ is the complexified Lie algebra of the gauge group. It admits $R$-symmetry group $G_R=\Spin(2, \RR)$ which acts with weight $1/2$ on $W$ and weight $-1/2$ on $W^*$.
...
\item Fermions $\chi\in\Omega^0(M; \gg)[-1]$, $B\in\Omega^{0, 2}(M; \gg)[-1]$, $\wt \chi\in\Omega^{0, 4}(M; \gg)[-1]$, $\psi\in\Omega^{1, 0}(M; \gg)[1]$ and $C\in\Omega^{3, 0}(M; \gg)[1]$.
...
Finally we discuss the case of the partially topological supercharge $Q\in\Sigma$. We consider the twisting homomorphism $\phi\colon \SU(3)\times \Spin(2, \RR)\rightarrow G_R=\Spin(2, \RR)$ given by projection on the second factor.
...
\end{thm}
\begin{proof}
The claim follows from Theorem \ref{thm:10dCSreduction} applied to $L=\CC^3$.
\end{proof}
...
Let $\fg$ be a complex Lie algebra equipped with a symmetric bilinear invariant nondegenerate pairing. We consider $\cN=1$ super Yang--Mills theory on $M=\RR^7$ with the Euclidean metric, where $\fg$ is the complexified Lie algebra of the gauge group. It admits $R$-symmetry group $G_R=\Spin(3, \RR)$ with $W$ the two-dimensional spin representation.

The 7d $\cN=1$ supersymmetry algebra admits three twists:
\begin{itemize}
...
\end{thm}
\begin{proof}
The family of square-zero supercharges \eqref{eq:7dHodgefamily} may be obtained by dimensional reduction of the corresponding family $Q_t^8$ \eqref{eq:8dHodgefamily} in 8 dimensions. The twist of 7d $\cN=1$ super Yang--Mills with respect to $Q_t$ is obtained by dimensional reduction of the twist of 8d $\cN=1$ super Yang--Mills with respect to $Q_t^8$. The claim then follows from Theorem \ref{thm:8dHodgetwist} and Corollary \ref{cor:Hodgeholomorphicreduction}.
\end{proof}
...
\end{thm}
\begin{proof}
The claim follows from Theorem \ref{thm:10dCSreduction} applied to $L=\CC^2$.
\end{proof}
