...
\end{align*}
These functionals define an off-shell action of the $\cN = (0,1)$ supersymmetry on the vector multiplet, as the following proposition states. 
...
We note that the results in the section have appeared in \cite{SW4d}. 
...
\begin{prop}[\cite{SWchar}]
The minimal twist of 4d $\cN=1$ super Yang-Mills coupled to the $\cN=1$ chiral multiplet on \brian{a complex surface or $\CC^2$} is equivalent to holomorphic $BF$ theory coupled to the holomorphic $\beta\gamma$ system. 
\end{prop}
%
