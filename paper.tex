...
The dimensional reduction of 8d $\cN=1$ super Yang--Mills on $L\times N$ alond $\Re\colon N\rightarrow N_\RR$ is by definition the $(4+\dim(L))$-dimensional super Yang--Mills on $L\times N_\RR$ with 16 supercharges. Since $N\cong N_\RR\oplus iN_\RR$, this theory carries an action of the $R$-symmetry group $G_R=\U(1)\times \Spin(N_\RR)$. We consider the grading $\alpha\colon \U(1)\rightarrow G_\RR$ given by the embedding into the first copy of $\U(1)$ and a twisting homomorphism
...
The dimensional reduction of 6d super Yang--Mills on $L\times N$ alond $\Re\colon N\rightarrow N_\RR$ is by definition the $(3+\dim(L))$-dimensional super Yang--Mills on $L\times N_\RR$ with 8 supercharges. Since $N\cong N_\RR\oplus iN_\RR$, this theory carries an action of the $R$-symmetry group $G_R=\SU(2)\times \Spin(N_\RR)$. We consider a twisting homomorphism
...
\begin{prop}
Suppose $Q_t$ is the rank $(2,0)$ supercharge as above.
...
\begin{thm}
The twist of 4d $\cN=2$ super Yang--Mills with respect to the family $Q_t$ of square-zero supercharges is perturbatively equivalent to the holomorphic Hodge theory $\map(\CC^2, (U//g)_{\mr{Hod}})$. 
