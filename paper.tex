...
\begin{theorem} \label{thm: 5dholtwist}
...
\brian{Check that I applied the twisting homomorphism correctly. I'm not seeing square roots anymore.}
...
We will use the notation for fields of 4d $\cN=1$ super Yang--Mills from Section \ref{sect:8dholomorphictwist}. 
