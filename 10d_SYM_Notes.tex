...
\begin{remark}
I'm part way through trying to do these calculations myself, but for reference I found these calculations in the master's thesis \cite{Guillen} we've discussed before.  For instance for the commutator of two supersymmetries acting on a spinor see equation 2.1.13.
\end{remark}
