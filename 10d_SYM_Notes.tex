...
&= \delta_{[Q_1, Q_2]} A,
\end{align*}
where on the third line we used the fact that the pairing $\Gamma(-,-)$ is symmetric, i.e. $\lambda_1 \gamma^i \lambda_2 = \lambda_2 \gamma^i \lambda_1$, three times, and on the fourth and fifth lines we used the Clifford relations.  Similarly we can calculate
\begin{align*}
